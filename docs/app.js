            ...
            <div class="flex-1 flex overflow-visible relative" ref=${containerRef}>
                ...
                <div class="flex-1 overflow-visible relative bg-white" onScroll=${(e) => setContainerScroll({ left: e.target.scrollLeft, top: e.target.scrollTop })}>
                    ...
                    <${GanttGrid}
                        ...
                        updateTaskColorLabel=${updateTaskColorLabel}
                ...
                <${Legend}
                    colorLabels=${colorLabels}
                    editingColorLabelId=${editingColorLabelId}
                    setEditingColorLabelId=${setEditingColorLabelId}
                    updateColorLabelName=${updateColorLabelName}
                    updateColorLabelColor=${updateColorLabelColor}
